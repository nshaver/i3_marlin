...
//#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN PB15 // nshaver
...
#define E0_AUTO_FAN_PIN FAN1_PIN // nshaver
...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 300 // nshaver
  ...
  #define BLTOUCH_SET_5V_MODE // nshaver
  ...
  #define BLTOUCH_HS_MODE true // nshaver
...
//#define BABYSTEPPING
  ...
  #define BABYSTEP_WITHOUT_HOMING // nshaver
  ...
  #define BABYSTEP_MILLIMETER_UNITS       		// nshaver
  #define BABYSTEP_MULTIPLICATOR_Z  0.1       // nshaver
  #define BABYSTEP_MULTIPLICATOR_XY 0.1       // nshaver
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping // nshaver
  #if ENABLED(BABYSTEP_ZPROBE_OFFSET)
    //#define BABYSTEP_HOTEND_Z_OFFSET      // For multiple hotends, babystep relative Z offsets
    //#define BABYSTEP_ZPROBE_GFX_OVERLAY   // Enable graphical overlay on Z-offset editor
    #define BABYSTEP_GFX_OVERLAY          // nshaver
  #endif
#endif
...
#define ADVANCED_PAUSE_FEATURE true // nshaver
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      50  // nshaver
